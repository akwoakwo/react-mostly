export default function CardPaket({ nama_subpaket, harga, benefits, extraBenefits, id }: any) {
  return (
    <div key={id} className="rounded-xl border border-gray-300 shadow-sm p-10 flex flex-col justify-between min-h-[400px] bg-white w-80 m-6" style={{ boxShadow: "0 2px 8px 0 rgba(52,44,84,0.08)" }}>
        <div>
            ...
            <a href={`/pemesanan`} className="block bg-[#342C54] hover:bg-orange-500 text-white py-2 rounded-lg w-full text-center text-[15px] mt-5 mb-4 transition">
                Pesan Sekarang
            </a>
